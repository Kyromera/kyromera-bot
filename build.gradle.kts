...
dependencies {
    ...
    implementation("dev.reformator.stacktracedecoroutinator:stacktrace-decoroutinator-jvm:2.5.7")
    ...
    runtimeOnly("io.netty:netty-resolver-dns-native-macos:4.2.4.Final:osx-x86_64")
